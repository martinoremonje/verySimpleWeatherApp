        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex-shrink-0">
              <Link to="/" className="rounded-full overflow-hidden w-16 h-16 block">
            ...
            <div className="w-full md:w-1/2 lg:w-1/2 text-left"> {/* Contenedor a la derecha, texto a la izquierda */}
              ...
              <form className="max-w-lg">
                ...
                <div className="mb-4">
                  ...
                  <textarea id="mensaje" rows="4" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"></textarea>
                </div>
